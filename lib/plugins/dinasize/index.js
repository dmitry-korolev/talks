(function() {
  ...
  const init = () => {
    const h1 = Array.from(document.querySelectorAll('.reveal .slides h1:not([data-dinasize-ignore])'))
    const contentWidth = parseInt(document.querySelector('.slides').style.width, 10)
